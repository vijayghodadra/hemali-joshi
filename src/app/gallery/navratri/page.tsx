...
export const metadata: Metadata = {
    title: "Navratri Gallery | Himali Joshi - Professional Singer",
    description: "Capturing the vibrant moments of Navratri celebration. Explore the Navratri performance gallery of Himali Joshi.",
};
            ...
            <div className="w-full px-4 md:px-8 max-w-[1600px] mx-auto">
                ...
                <div className="mb-16 text-center relative flex flex-col items-center">
                    ...
                    <h1 className="font-serif text-4xl md:text-6xl mb-6 tracking-tighter uppercase">
                        NAVRATRI <span className="text-gold italic ml-4 font-allura normal-case tracking-normal">Nights</span>
                    </h1>
